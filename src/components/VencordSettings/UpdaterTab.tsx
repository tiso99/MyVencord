...
function Updater() {
    ...
    return (
        <SettingsTab title="MyVencord Updater">
            <Forms.FormTitle tag="h5">Updater Settings</Forms.FormTitle>
            <Switch
                value={settings.autoUpdate}
                onChange={(v: boolean) => settings.autoUpdate = v}
                note="Automatically update MyVencord without confirmation prompt"
            >
            ...
            <Switch
                ...
                note="Shows a notification when MyVencord automatically updates"
